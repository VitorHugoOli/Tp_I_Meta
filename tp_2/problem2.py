...
units = [
    ...
    {'min': 60, 'max':  60, 'a': 0.00324,'b': 7.74,'c': 240, 'e': 150, 'f':0.063 },
    {'min': 60, 'max':  60 , 'a': 0.00324,'b': 7.74,'c':240 , 'e': 150, 'f':0.063 },
    {'min': 60, 'max':  60 , 'a': 0.00324,'b': 7.74,'c':240 , 'e': 150, 'f':0.063 },
    {'min': 60, 'max':  60 , 'a': 0.00324,'b': 7.74,'c':240 , 'e': 150, 'f':0.063 },
    {'min': 60, 'max':  60 , 'a': 0.00324,'b': 7.74,'c':240 , 'e': 150, 'f':0.063 },
    {'min': 60, 'max':  60 , 'a': 0.00324,'b': 7.74,'c':240 , 'e': 150, 'f':0.063 },
    {'min': 40, 'max':  40 , 'a': 0.00284,'b':8.60 ,'c':126 , 'e': 100, 'f':0.084 },
    {'min': 40, 'max':  40 , 'a': 0.00284,'b':8.60 ,'c':126 , 'e': 100, 'f':0.084 },
    {'min': 55, 'max':  55 , 'a': 0.00284,'b': 8.60,'c':126 , 'e': 100, 'f':0.084 },
    {'min': 55, 'max':  55 , 'a': 0.00284,'b': 8.6,'c':126 , 'e': 100, 'f':0.084 },
]
